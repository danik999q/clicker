...
const setupDatabase = async () => {
    ...
    try {
        ...
        await client.query(`ALTER TABLE clans ADD COLUMN IF NOT EXISTS description TEXT DEFAULT ''`);
        await client.query(`ALTER TABLE clans ADD COLUMN IF NOT EXISTS avatar_url TEXT DEFAULT ''`);
